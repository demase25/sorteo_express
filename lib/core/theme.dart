    ...
    return ThemeData(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          elevation: 6,
          shadowColor: Color(0xFF1A1A1A).withOpacity(0.4),
        ),
      ),
      cardTheme: CardThemeData(
        color: cardColor,
        elevation: 4,
        shadowColor: Color(0xFF1A1A1A).withOpacity(0.2),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: TextStyle(color: textLightColor, fontSize: 16, fontWeight: FontWeight.w500),
        labelStyle: TextStyle(color: textSecondaryColor, fontSize: 16, fontWeight: FontWeight.w600),
      ),
      textTheme: TextTheme(
        bodyLarge: TextStyle(color: textPrimaryColor, fontSize: 16, fontWeight: FontWeight.w600),
        bodyMedium: TextStyle(color: textPrimaryColor, fontSize: 14, fontWeight: FontWeight.w500),
        ...
        headlineLarge: TextStyle(color: primaryColor, fontSize: 28, fontWeight: FontWeight.bold),
      ),
    );
  }
