...
class AppTheme {
  // Colores principales - Deep Sky Blue hermoso
  static const Color primaryColor = Color(0xFF00BFFF); // Deep Sky Blue principal
  static const Color secondaryColor = Color(0xFF40C4FF); // Deep Sky Blue claro
  static const Color accentColor = Color(0xFF80D8FF); // Deep Sky Blue brillante
  static const Color errorColor = Color(0xFFE57373); // Rojo suave
  static const Color warningColor = Color(0xFFFFB74D); // Naranja suave

  // Colores adicionales - Paleta Deep Sky Blue
  static const Color lightBlue = Color(0xFFB3E5FC); // Azul muy claro
  static const Color darkBlue = Color(0xFF0099CC); // Azul oscuro
